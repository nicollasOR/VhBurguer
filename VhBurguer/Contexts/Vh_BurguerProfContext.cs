...
public partial class Vh_BurguerProfContext : DbContext
{
    public Vh_BurguerProfContext()
    {
    }

    public Vh_BurguerProfContext(DbContextOptions<Vh_BurguerProfContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=Vh_BurguerProf;Trusted_Connection=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.CategoriaID).HasName("PK__Categori__F353C1C5731F5DA7");
        ...
        {
            entity.HasKey(e => e.Log_AlteracaoProdutoID).HasName("PK__Log_Alte__D06C51B7A47ADF1C");
        ...
        {
            entity.HasKey(e => e.ProdutoID).HasName("PK__Produto__9C8800C3C8963861");
            ...
            entity.HasIndex(e => e.Nome, "UQ__Produto__7D8FE3B272B60816").IsUnique();
        ...
        {
            entity.HasKey(e => e.PromocaoID).HasName("PK__Promocao__254B583DD56D2883");
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE79848A73E6B");

            entity.ToTable(tb => tb.HasTrigger("trg_ExclusaoUsuario"));

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534F912978E").IsUnique();
